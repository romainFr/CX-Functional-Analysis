...
JLD.save("data/interpolatedData.jld",large_interpolated_data_dict)
...
JLD.save("data/statTables.jld","stats_per_run",stats_per_run,"stats_per_pair",stats_per_pair,"uniqueTypesUsed",uniqueTypesUsed,"stats_per_pair_20",stats_per_pair_20)

JLD.save("data/drugTables.jld","mecadf",mecadf,"picrodf",picrodf,"drugStats",drugStatsDFPerPair)
