...
function readLabbook(tablePath,lines;expDay=nothing,tagExcl=":Problematic:")
    labTable = CSV.read(tablePath,null="NA",dateformat="yyyy-mm-dd e",weakrefstrings=false,quotechar=''')#readtable(tablePath,nastrings=["NA"])
